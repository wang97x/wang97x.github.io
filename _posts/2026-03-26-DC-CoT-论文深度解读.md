---
layout: post
title: 论文深度解读 | DC-CoT：数据为中心的思维链蒸馏基准研究
date: 2026-03-26 10:30:00 +0800
categories: [论文阅读，大语言模型]
tags: [LLM, 思维链，蒸馏，数据增强，泛化能力]
math: true
mermaid: true
image: /assets/img/papers/2505.18759/fig1_page1.png
---
...
![DC-CoT 框架图](/assets/img/papers/2505.18759/fig1_page1.png)
*图 1: DC-CoT 基准框架总览（来源：arXiv:2505.18759）*

框架说明：
- **数据生成**：使用强教师模型生成初始 CoT 数据
- **数据操作**：增强、选择、混合三种策略
- **学生训练**：在操作后的数据上训练小模型
...
![数据增强方法对比](/assets/img/papers/2505.18759/fig2_page1.png)
...
| 选择策略 | 数据量 | GSM8K | MATH | 训练时间 |
|---------|--------|-------|------|---------|
| 随机选择 | 100%   | 45.2  | 32.1 | 12h     |
| **质量筛选** | **30%**    | **52.8**  | **41.5** | **4h**      |
| 多样性优先 | 50%  | 51.3  | 43.2 | 6h      |
...
![IID vs OOD 性能对比](/assets/img/papers/2505.18759/fig3_page1.png)
...
![消融实验结果](/assets/img/papers/2505.18759/fig4_page1.png)
